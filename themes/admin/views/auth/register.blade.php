        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7 px-5 pt-3">
                    <h2 class="font-wight-bold py-3" style="font-family:DejaVu Sans Mono, monospace;">NPI General Academy</h2>
                        ...
                        @csrf
                            <div class="form-row">
                                <div class="col-md-10">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Ex:. LucianaD">
                                        @error('name')
