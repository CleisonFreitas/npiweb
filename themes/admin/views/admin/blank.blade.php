...
<head>
    ...
    <title>NPI Administrador - @yield('title')</title>
     ...
     <link href="{{ asset('css/npiweb.min.css') }}" rel="stylesheet">
...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('admin.funerario')}}">Funerário</a>
                        <a class="collapse-item" href="{{route('admin.cemiterio')}}">Cemitério</a>
                        <a class="collapse-item" href="{{route('admin.clinica')}}">Clínica</a>
                        <a class="collapse-item" href="{{route('admin.contabil')}}">Contábil</a>
                        <a class="collapse-item" href="{{route('admin.mobile')}}">Mobile</a>
                        <a class="collapse-item" href="{{route('admin.veicular')}}">Veicular</a>
                        <a class="collapse-item" href="{{route('admin.emissor')}}">Emissor</a>
                        <a class="collapse-item" href="{{route('admin.telemarketing')}}">Telemarketing</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('admin.register') }}">Cadastrar Novo</a>
                        <a class="collapse-item" href="{{ route('admin.editar', Auth::guard('admin')->user()->id) }}">Alterar Login</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Entenda sobre:</h6>
                        <a class="collapse-item" href="{{ route('admin.conteudo') }}">Conteúdo</a>
                        <a class="collapse-item" href="{{ route('admin.notificacoes') }}">Requisições</a>
                        <a class="collapse-item" href="{{ route('admin.uti.colaborador')}}">Cadastro Colaborador</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- #Topbar Search -->
                    <h6>Painel Administrador @yield('admin')</h6>
                    <!-- Topbar Navbar -->
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile"
                                    src="/img/{{Auth::guard('admin')->user()->profile}}">
                            </a>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Ao continuar, vocês será redirecionado para a página de login.</div>
    ...
    <script src="{{ asset('js/npiweb.min.js') }}"></script>
    ...
    <script>
      Swal.fire(
    'Alerta!',
    'Erro ao tentar realizar procedimento!',
    'error'
  )
  </script>    
  @endif
